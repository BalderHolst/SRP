...
#working dir
setwd("/home/Balder/Documents/Skole/Gym/3. G/SRP/opgaven/data/9")
...
setwd("/home/Balder/Documents/Skole/Gym/3. G/SRP/mundtlig eksamen/img")
...
ggsave("toAlgoritmerZoomed(BIG).png")
...
ggplot(M, aes(x=log10(model), y=residual, colour=Algorithm)) +
	...
	ggsave("toAlgoritmerResidual(BIG).png")
...
ggplot(subset(M,n <= 100), aes(x=n, y=t, colour=Algorithm)) +
	...
	ggsave("toAlgoritmerZoomedGns(BIG).png")


# =================================================================
# Her er hybridalgoritmens plots

#working dir
setwd("/home/Balder/Documents/Skole/Gym/3. G/SRP/opgaven/data/the_second_one")
...
ggplot(subset(M,n <= 100), aes(x=n, y=t, colour=Algorithm)) +
  ...
  theme(legend.position="top",legend.title = element_blank())
	...
	ggsave("toMergesortZoomed(BIG).png",width=5,height=4,scale=1.3)
...
#theme(legend.position="bottom",legend.title = element_blank())
	...
	ggsave("toMergesortResidual(BIG).png")
